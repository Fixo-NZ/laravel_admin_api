...
class HomeownerAuthController extends Controller
{
    ...
    public function register(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            'first_name'        => 'required|string|max:255',   // Required, max 255 chars
            'middle_name'        => 'required|string|max:255',   // Required, max 255 chars
            'last_name'        => 'required|string|max:255',   // Required, max 255 chars
