...
Route::prefix('feedback')->group(function () {
    ...
    // PROTECTED: POST new review - stores in Laravel database with authenticated user
    Route::middleware('auth:sanctum')->post('reviews', [ReviewController::class, 'storeFeedback'])->name('feedback.reviews');
